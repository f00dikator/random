...
/* OFFSET: 0       473     (0.084661)
 * OFFSET: 1       496     (0.088778)
 * OFFSET: 2       2875    (0.514587)
 * OFFSET: 3       508     (0.090925)
 * OFFSET: 4       481     (0.086093)
 * OFFSET: 5       487     (0.087167)
 * OFFSET: 6       498     (0.089135)
 * OFFSET: 7       473     (0.084661)
 * OFFSET: 8       452     (0.080902)
 * OFFSET: 9       498     (0.089135)
 * OFFSET: 10      510     (0.091283)
 * OFFSET: 11      480     (0.085914)
 * OFFSET: 12      499     (0.089314)
 * OFFSET: 13      441     (0.078933)
 * OFFSET: 14      525     (0.093968)
 * OFFSET: 15      492     (0.088062)
 * OFFSET: 16      460     (0.082334)
 * OFFSET: 17      482     (0.086272)
 * OFFSET: 18      502     (0.089851)
 * OFFSET: 19      0       (0.000000)
 * */

const char motherfuzzer[] =
"\xC1\xA1\x02\x75\xBF\x40\xA4\x3F\x7A\x33\x09\x60\x05\x92\x05\xE8"
"\xC0\x82\x0A"
;
...
int main(int argc, char *argv[]) 
{
	...
	printf("Generic Protocol fuzzer [jwl]\n\n");
        ...
        if (argc < 3) 
	{
                fprintf(stderr, "Use: %s [ip] [port (14898)]\n", argv[0]);
                exit(1);
        }
